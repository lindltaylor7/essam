...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 13754));
...
function Roles() {
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            const response = await _utils_axiosInstance__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.post('/mines', data);
    ...
    const deleteMine = (id)=>{
        return async ()=>{
            try {
                // Enviar los datos del formulario al servidor en el puerto 4000
                const response = await _utils_axiosInstance__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.delete("/mines/".concat(id));
                // Si la respuesta es exitosa, redirigir a /organizations
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("tbody", {
                            ...
                            children: mines.map((mine)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                    children: [
...
/******/ __webpack_require__.O(0, [464,558,441,684,358], () => (__webpack_exec__(5297)));
